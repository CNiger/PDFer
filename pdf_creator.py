...
Original file is located at
    https://colab.research.google.com/drive/1M4ldom-ZUe9NhRuwnrE_t2ud52HmPK3T
"""

!pip install pyTelegramBotAPI
!pip install pyTelegramBotAPI pillow python-docx
...
TOKEN = "8204855927:AAE6WxvaZl-kqM3zbSRql1J_dr1l1NteYeA"
...
def start(message):
    ...
    if user_id not in user_sessions:
        user_sessions[user_id] = {'photos': [], 'format': 'pdf'}  # По умолчанию PDF
...
def create_docx(photos_bytes):
    ...
    content_width = 7.5  # 8.5 - 0.5 - 0.5 = 7.5 дюймов
    content_height = 10.0  # 11 - 0.5 - 0.5 = 10 дюймов
